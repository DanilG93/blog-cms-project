...
<title>Blog Post Site | Log in</title>
...
<!-- icheck bootstrap -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin-theme/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
<!-- Theme style -->
