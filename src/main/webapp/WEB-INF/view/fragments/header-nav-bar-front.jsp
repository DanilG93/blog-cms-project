...
<nav class="navbar navbar-expand-lg">
   <div class="search-area">
      <div class="search-area-inner d-flex align-items-center justify-content-center">
         ...
         <div class="row d-flex justify-content-center">
            <div class="col-md-8">
               <form action="${pageContext.request.contextPath}/search-handler" method="get">
                  <div class="form-group">
                     <input type="text" name="term" id="search" placeholder="What are you looking for?">
   ...
   <div class="container">
      ...
      <div class="navbar-header d-flex align-items-center justify-content-between">
         <!-- Navbar Brand -->
         <a href="${pageContext.request.contextPath}" class="navbar-brand">Bootstrap Blog</a>
         <!-- Toggle Button-->
