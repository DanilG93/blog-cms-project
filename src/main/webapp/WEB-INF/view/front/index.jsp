...
<body>
   ...
   <div id="index-slider" class="owl-carousel">
      <section
         style="background: url(${pageContext.request.contextPath}/front-theme/img/featured-pic-1.jpeg); background-size: cover; background-position: center center"
         class="hero">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
      ...
      <section
         style="background: url(${pageContext.request.contextPath}/front-theme/img/featured-pic-2.jpeg); background-size: cover; background-position: center center"
         class="hero">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
      ...
      <section
         style="background: url(${pageContext.request.contextPath}/front-theme/img/featured-pic-3.jpeg); background-size: cover; background-position: center center"
         class="hero">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
      ...
      <div class="container">
         ...
         <div class="row d-flex align-items-stretch">
               ...
               <div class="text-inner d-flex align-items-center">
                  <div class="content">
                     ...
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                        ad minim veniam, quis nostrude consectetur adipisicing elit, sed do eiusmod tempor incididunt.</p>
                     <footer class="post-footer d-flex align-items-center">
                        <a href="blog-author.html" class="author d-flex align-items-center flex-wrap">
                           <div class="avatar">
                              <img src="${pageContext.request.contextPath}/front-theme/img/avatar-1.jpg" alt="..." class="img-fluid">
                           </div>
                           <div class="title">
                              <span>John Doe</span>
                           </div>
            ...
            <div class="image col-lg-5">
               <img src="${pageContext.request.contextPath}/front-theme/img/featured-pic-1.jpeg" alt="...">
            </div>
         </div>
         <!-- Post        -->
         <div class="row d-flex align-items-stretch">
            <div class="image col-lg-5">
               <img src="${pageContext.request.contextPath}/front-theme/img/featured-pic-2.jpeg" alt="...">
            </div>
            <div class="text col-lg-7">
               <div class="text-inner d-flex align-items-center">
                  <div class="content">
                     ...
                     <footer class="post-footer d-flex align-items-center">
                        <a href="blog-author.html" class="author d-flex align-items-center flex-wrap">
                           <div class="avatar">
                              <img src="${pageContext.request.contextPath}/front-theme/img/avatar-2.jpg" alt="..." class="img-fluid">
                           </div>
                           <div class="title">
                              <span>John Doe</span>
                           </div>
         ...
         <div class="row d-flex align-items-stretch">
               ...
               <div class="text-inner d-flex align-items-center">
                  <div class="content">
                     ...
                     <footer class="post-footer d-flex align-items-center">
                        <a href="blog-author.html" class="author d-flex align-items-center flex-wrap">
                           <div class="avatar">
                              <img src="${pageContext.request.contextPath}/front-theme/img/avatar-3.jpg" alt="..." class="img-fluid">
                           </div>
                           <div class="title">
                              <span>John Doe</span>
                           </div>
            ...
            <div class="image col-lg-5">
               <img src="${pageContext.request.contextPath}/front-theme/img/featured-pic-3.jpeg" alt="...">
            </div>
         </div>
      </div>
   </section>
            ...
            <div class="row">
               <div class="post col-md-4">
                  <div class="post-thumbnail">
                     <a href="blog-post.html">
                        <img src="${pageContext.request.contextPath}/front-theme/img/blog-1.jpg" alt="..." class="img-fluid">
                     </a>
                  </div>
               ...
               <div class="post col-md-4">
                  <div class="post-thumbnail">
                     <a href="blog-post.html">
                        <img src="${pageContext.request.contextPath}/front-theme/img/blog-2.jpg" alt="..." class="img-fluid">
                     </a>
                  </div>
                  <div class="post-details">
                     <div class="post-meta d-flex justify-content-between">
                        <div class="date">20 May | 2016</div>
                        <div class="category">
                           <a href="blog-category.html">Technology</a>
                        </div>
                     </div>
                     <a href="blog-post.html">
               ...
               <div class="post col-md-4">
                  <div class="post-thumbnail">
                     <a href="blog-post.html">
                        <img src="${pageContext.request.contextPath}/front-theme/img/blog-3.jpg" alt="..." class="img-fluid">
                     </a>
                  </div>
                  <div class="post-details">
                     <div class="post-meta d-flex justify-content-between">
                        <div class="date">20 May | 2016</div>
                        <div class="category">
                           <a href="blog-category.html">Financial</a>
                        </div>
                     </div>
                     <a href="blog-post.html">
